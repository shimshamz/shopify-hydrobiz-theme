    ...
    _createClass(ProductVariants, [{
      ...
      value: function _updateDiscountLabel(newVariant, previousVariant) {
        ...
        if (!newVariant || !(newVariant['price'] < newVariant['compare_at_price'])) {
          ...
          discountLabel.innerHTML = "".concat(window.languages.collectionOnSaleLabel.replace('', savings));
        ...
        if (isOk) {
          ...
          if (shippingRates.length === 0) {
            ...
            if (shippingRates.length === 1) {
              ...
              resultsElement.innerHTML = "<p>".concat(window.languages.shippingEstimatorMultipleResults.replace('', shippingRates.length), "</p>");
            }
